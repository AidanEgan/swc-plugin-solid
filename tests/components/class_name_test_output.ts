...
var _tmpl$1 = /*#__PURE__*/ _$template('<button class="bg-red p-2 m-4" type=button>Click Me!'), _tmpl$2 = /*#__PURE__*/ _$template('<button class="bg-purple w-[10] h-4" type=button>Click Me!'), _tmpl$3 = /*#__PURE__*/ _$template('<button class="border-solid border-2 border-pink p-10">Click Me!'), _tmpl$4 = /*#__PURE__*/ _$template("<button>Click Me!"), _tmpl$5 = /*#__PURE__*/ _$template("<button>");
function Counter() {
